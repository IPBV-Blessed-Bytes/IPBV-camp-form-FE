              ...
              <Container>
                <div className="form__success text-center">
                  <div className="form__success__title">
                    <h2>
                      <b>
                        As inscrições para o acampamento de 2025 foram encerradas. Nos vemos no sábado em Garanhuns!
                      </b>
                    </h2>
                  </div>
                  <div className="waiting-for-camp-buttons mb-4">
                    <div className="waiting-for-camp-buttons__verify">
                      ...
                      <Card.Text>
                        Insira seu CPF e data de nascimento para verificar seus dados de inscrição, caso esteja
                        inscrito. Acompanhantes, pacote, status de pagamento, alimentação, contato de carona, valor
                        pago, entre outros.
                      </Card.Text>
                    ...
                    <div className="waiting-for-camp-buttons-faq">
                      ...
                      <Card.Text>
                        Visualize aqui algumas perguntas frequentes e suas respostas. Já foi a dúvida de outros, pode
                        ser a sua também!
                      </Card.Text>
                      <div className="waiting-for-camp-buttons__verify-button">
                  ...
                  <p>
                    <em>
                      Informamos que cancelamentos devem ser solicitados com, no máximo, 7 dias de antecedência da data
                      do acampamento, com reembolso limitado a 50% do valor total.
                    </em>
                  </p>
