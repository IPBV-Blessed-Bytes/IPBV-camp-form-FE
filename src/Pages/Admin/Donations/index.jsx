...
const AdminDonations = ({ loggedUsername }) => {
  ...
  useEffect(() => {
    listAllDonations()
      .then((list) => {
        // Só doações pagas (CONFIRMED). Pendentes podem nunca ser pagas — não devem
        // aparecer como doação. Filtro também no FE para robustez caso o BE ainda não
        // esteja atualizado.
            ...
            <div className="admin-table-card">
              <Table striped bordered hover responsive className="custom-table">
                ...
                <tbody>
                  {donations.length === 0 ? (
                    <tr>
                      <td colSpan={7} className="text-start text-secondary py-4">
