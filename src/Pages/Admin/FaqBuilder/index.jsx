  ...
  return (
    <div className="admin-subpage faq-builder">
      <AdminSubpageHeader
        ...
        subtitle="Perguntas exibidas na página de FAQ do formulário."
        typeIcon="question"
      />
        ...
        <Form>
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              placeholder="Ex.: Quando e onde será o acampamento?"
            />
          </Form.Group>
          <Form.Group>
            <Form.Label>
            ...
            <CustomEditor value={draft.answer} onChange={(value) => setDraft((prev) => ({ ...prev, answer: value }))} />
          </Form.Group>
        </Form>
      </CustomModal>
