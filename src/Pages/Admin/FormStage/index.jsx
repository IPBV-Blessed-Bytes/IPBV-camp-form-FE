...
const AdminFormStage = ({ loggedUsername }) => {
  ...
  const handleConfirmChange = async () => {
    ...
    try {
      ...
      registerLog(`Alterou o estágio do formulário para ${stageLabels[selectedStage]}`, loggedUsername);
    } catch (error) {
  ...
  return (
    <div className="admin-subpage admin-subpage--settings">
      ...
      <div className="admin-subpage__content">
        ...
        >
          Tem certeza de que deseja alterar o estágio do formulário para <b>{stageLabels[selectedStage]}</b>?
        </CustomModal>
