  ...
  return (
	...
	c6.074-6.075,6.074-15.909,0-21.986L285.08,230.397z"
        ...
        >
          <g>
            <g>
              <g>
                <g>
                  <path d="M41.562,130.891c-12.271,0-22.237,9.946-22.237,22.11c0,12.222,9.966,22.198,22.237,22.198      c12.154,0,22.051-9.975,22.051-22.198C63.614,140.817,53.716,130.891,41.562,130.891z M41.562,166.747      c-7.611,0-13.786-6.185-13.786-13.756c0-7.523,6.175-13.639,13.786-13.639c7.484,0,13.6,6.106,13.6,13.639      C55.162,160.563,49.046,166.747,41.562,166.747z" />
                  <path d="M41.504,145.106c-4.426,0-7.972,3.566-7.972,7.924c0,4.436,3.556,7.943,7.972,7.943      c4.367,0,7.894-3.498,7.894-7.943C49.398,148.663,45.871,145.106,41.504,145.106z" />
                  <path d="M249.081,81.376H0v73.266h18.856l-0.039-1.593c0-12.496,10.122-22.647,22.745-22.647      c12.457,0,22.569,10.151,22.569,22.647l-0.039,1.602h105.361l-0.059-1.602c0-12.496,10.19-22.647,22.745-22.647      c12.457,0,22.628,10.151,22.628,22.647l-0.107,1.602h43.507v-32.945L249.081,81.376z M27.845,87.55v29.408H6.917l0.059-29.447      L27.845,87.55L27.845,87.55z M70.668,116.92H32.808V87.531l37.859,0.068V116.92z M113.539,116.929H75.66v-29.33l37.879,0.059      V116.929z M156.401,148.643h-37.859V87.648l37.859,0.166V148.643z M199.243,116.929h-37.879V87.717l37.879,0.098V116.929z       M204.196,116.91L204.196,116.91V87.795l41.318,0.078l6.302,29.066L204.196,116.91z" />
                  <rect x="133.9" y="92.006" width="5.989" height="52.495" />
                  <path d="M192.521,132.474c-12.252,0-22.217,9.946-22.217,22.129c0,12.222,9.956,22.188,22.217,22.188      c12.135,0,22.032-9.966,22.032-22.188C214.553,142.42,204.656,132.474,192.521,132.474z M192.482,168.311      c-7.562,0-13.747-6.165-13.747-13.717c0-7.523,6.185-13.639,13.747-13.639c7.533,0,13.639,6.126,13.639,13.639      C206.111,162.175,200.005,168.311,192.482,168.311z" />
                  <path d="M192.482,146.699c-4.445,0-7.982,3.517-7.982,7.933s3.537,7.933,7.982,7.933      c4.348,0,7.894-3.507,7.894-7.933C200.367,150.246,196.83,146.699,192.482,146.699z" />
                </g>
              </g>
            </g>
          </g>
      ...
      {typeIcon === 'logs' && (
        ...
        >
          <g>
            <path
              d="M23.3,94.7v280.5c0,46.8,77.5,82.1,180.3,82.1c9.7,0,19.5-0.3,29.1-1c6.7-0.5,11.8-6.3,11.4-13.1
		...
		c-51,0-92.5-41.5-92.5-92.5s41.5-92.5,92.5-92.5s92.5,41.5,92.5,92.5S422.7,475,371.7,475z"
            />
            <path
              d="M416.3,370.2H353l11.1-12.1c4.6-5,4.2-12.7-0.8-17.3c-5-4.6-12.7-4.2-17.3,0.8l-29.8,32.6c-4.3,4.7-4.3,11.8,0,16.5
	...
	c6.074-6.075,6.074-15.909,0-21.986L285.08,230.397z"
      ...
      {typeIcon === 'checkin' && (
        ...
        >
          <path
            d="M26,2C15.5,2,7,10.5,7,21.1c0,13.2,13.6,25.3,17.8,28.5c0.7,0.6,1.7,0.6,2.5,0C31.5,46.3,45,34.3,45,21.1
	C45,10.5,36.5,2,26,2z M26,29c-4.4,0-8-3.6-8-8s3.6-8,8-8s8,3.6,8,8S30.4,29,26,29z"
      ...
      {typeIcon === 'aggregate' && (
        ...
        >
          <g>
            <path
              d="M24.989,15.893c-0.731-0.943-3.229-3.73-4.34-4.96c0.603-0.77,0.967-1.733,0.967-2.787c0-2.503-2.03-4.534-4.533-4.534
      ...
      {typeIcon === 'form-context' && (
        ...
        >
          <g>
            ...
            />
            <polygon fill={fill} points="3.818,44.644 7.077,47.889 11.984,42.967 8.738,39.709  " />
            <path
	...
	c0,6.383,2.157,12.273,5.78,16.978C148.519,148.499,131.311,156.987,112.665,156.987z"
      ...
      {typeIcon === 'simple-info' && (
        ...
        >
          <g>
            <path
              d="M232.5,147.663c40.711,0,73.832-33.121,73.832-73.832S273.211,0,232.5,0s-73.832,33.12-73.832,73.831
		...
		s-58.832-26.392-58.832-58.832C173.668,41.392,200.06,15,232.5,15z"
            />
            <path
              d="M323.332,217.985c4.142,0,7.5-3.357,7.5-7.5v-40.319c0-4.143-3.358-7.5-7.5-7.5H141.668c-4.142,0-7.5,3.357-7.5,7.5v40.319
      ...
      {typeIcon === 'form' && (
        ...
        >
          <g>
            <path
              d="M415.5,32h-80.001c-0.089,0-0.175,0.01-0.262,0.013C328.033,22.305,316.49,16,303.5,16h-20.68
		...
		H415.5c13.509,0,24.5,10.991,24.5,24.5V471.5z"
            />
            <path
              d="M415.5,64h-48c-4.142,0-7.5,3.358-7.5,7.5s3.358,7.5,7.5,7.5H408v281h-80.5c-12.958,0-23.5,10.542-23.5,23.5v47.999
		...
		C423,67.358,419.642,64,415.5,64z"
            />
            <path
              d="M255.5,32c-1.97,0-3.91,0.8-5.3,2.2c-1.4,1.39-2.2,3.33-2.2,5.3c0,1.98,0.8,3.91,2.2,5.3c1.39,1.4,3.33,2.2,5.3,2.2
		c1.97,0,3.91-0.8,5.3-2.2c1.4-1.39,2.2-3.33,2.2-5.3s-0.8-3.91-2.2-5.3C259.41,32.8,257.47,32,255.5,32z"
            ...
            <path
              d="M375,335.5c0-4.142-3.358-7.5-7.5-7.5h-224c-4.142,0-7.5,3.358-7.5,7.5s3.358,7.5,7.5,7.5h224
		C371.642,343,375,339.642,375,335.5z"
            ...
            <path
              d="M136,167.5c0,4.142,3.358,7.5,7.5,7.5H176v32.5c0,4.142,3.358,7.5,7.5,7.5s7.5-3.358,7.5-7.5V175h32.5
      ...
      {typeIcon === 'wristband' && (
        ...
        >
          <g>
            <g>
              <g>
                <path d="M474.433,218.339v-31.351c0-69.695-167.048-83.669-237.21-83.669C167.192,103.318,0,117.277,0,186.988v138.025     c0,69.703,167.076,83.669,237.223,83.669c70.039,0,237.21-13.966,237.21-83.669v-28.928c20.834-0.71,37.567-17.869,37.567-38.872     C512,236.208,495.267,219.05,474.433,218.339z M237.223,143.567c122.539,0,192.142,29.235,196.922,43.414     c-1.021,3.092-7.093,7.406-9.834,9.182c-91.401-39.076-282.826-39.059-374.19,0c-2.694-1.743-8.88-6.228-9.835-9.182     C44.987,173.02,113.819,143.567,237.223,143.567z M360.51,218.742c-73.042,15.574-173.476,15.587-246.584,0     C186.981,203.253,287.403,203.24,360.51,218.742z M434.185,324.894L434.185,324.894c-3.598,13.317-71.812,43.537-196.961,43.537     c-121.888,0-193.127-29.294-196.975-43.537v-88.053c88.791,44.863,303.95,45.256,393.936,0V324.894z" />
      ...
      {typeIcon === 'dart' && (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <line fill="none" stroke={stroke || '#000000'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" x1="16" y1="16" x2="22" y2="10" />
          <polygon fill="none" stroke={stroke || '#000000'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" points="30,6 26,6 26,2 22,6 22,10 26,10 " />
          <circle fill="none" stroke={stroke || '#000000'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" cx="16" cy="16" r="6" />
          <path fill="none" stroke={stroke || '#000000'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M27,9c1.3,2,2,4.4,2,7c0,7.2-5.8,13-13,13S3,23.2,3,16S8.8,3,16,3c2.6,0,5,0.7,7,2" />
        </svg>
      )}
      ...
      {typeIcon === 'instagram' && (
        <svg className={className} onClick={onClick} height={iconSize ? iconSize + 'px' : '30px'} width={iconSize ? iconSize + 'px' : '30px'} viewBox="0 0 16 16" fill={fill || 'currentColor'} xmlns="http://www.w3.org/2000/svg">
      ...
      {typeIcon === 'spotify' && (
        <svg className={className} onClick={onClick} height={iconSize ? iconSize + 'px' : '30px'} width={iconSize ? iconSize + 'px' : '30px'} viewBox="0 0 24 24" fill={fill || 'currentColor'} xmlns="http://www.w3.org/2000/svg">
          <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.42 1.56-.299.421-1.02.599-1.559.24z" />
        </svg>
      )}
